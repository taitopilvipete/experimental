...
trait GenericPokerHandComparatorTest {
  ...
  def runTestsForHands(compareFunction: (PokerHand, PokerHand) => Integer)(hand1: PokerHand, hand2: PokerHand, expectedResult: Char) = {
  ...
  def testAllPermutations(compareFunction: (PokerHand, PokerHand) => Integer)(hand1: PokerHand, hand2: PokerHand, expectedResult: Char) = {
  ...
  def testBothWays(compareFunction: (PokerHand, PokerHand) => Integer)(hand1: PokerHand, hand2: PokerHand, expectedResult: Char) = {
